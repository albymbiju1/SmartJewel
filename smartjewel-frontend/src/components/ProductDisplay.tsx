...
import { Filter as LucideFilter, Heart as HeartIcon, LayoutGrid, List as ListIcon, SlidersHorizontal, ShoppingCart as CartIcon, Camera } from 'lucide-react';
                      ...
                      <div className={`${viewMode === 'list' ? 'w-48 flex-shrink-0' : ''} aspect-square overflow-hidden relative`}>
                        ...
                        <div className="absolute top-2 right-2 flex flex-col gap-2">
                          ...
                          <button
                            ...
                            aria-label="Try this product virtually"
                            className="p-2 rounded-full bg-white/90 shadow hover:bg-white transition-all hover:scale-105"
                            onClick={(e) => {
                              e.stopPropagation();
                          ...
                          >
                            <Camera className="w-5 h-5 text-amber-600" strokeWidth={1.5} />
                          </button>
                        </div>
                      </div>
                ...
                <div className="mt-12 mb-8">
                  <div className="flex items-center justify-center gap-2 flex-wrap">
                    ...
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg border font-medium transition-all ${currentPage <= 1
                        ...
                        if (totalPages > 0) {
                          pages.push(
                            <button
                              ...
                              className={`px-3 py-2 rounded-lg border min-w-[40px] font-medium transition-all ${1 === currentPage
                        ...
                        for (let p = start; p <= end; p++) {
                          pages.push(
                            <button
                              ...
                              className={`px-3 py-2 rounded-lg border min-w-[40px] font-medium transition-all ${p === currentPage
                                ? 'bg-blue-600 text-white border-blue-600 shadow-md'
                                : 'border-gray-300 text-gray-700 hover:bg-gray-50'
                                }`}
                            >
                        ...
                        if (totalPages > 1) {
                          pages.push(
                            <button
                              ...
                              className={`px-3 py-2 rounded-lg border min-w-[40px] font-medium transition-all ${totalPages === currentPage
                                ? 'bg-blue-600 text-white border-blue-600 shadow-md'
                                : 'border-gray-300 text-gray-700 hover:bg-gray-50'
                                }`}
                            >
                    ...
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg border font-medium transition-all ${currentPage >= totalPages
                        ? 'text-gray-300 border-gray-200 cursor-not-allowed'
                        : 'text-gray-700 border-gray-300 hover:bg-gray-50 hover:border-gray-400'
                        }`}
                    >
