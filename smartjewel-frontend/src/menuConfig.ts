    ...
    columns: [
      {
        title: 'Shop by Category',
        items: [
          { label: 'Necklaces', href: '/products?category=necklaces&metal=gold' },
          { label: 'Rings', href: '/products?category=rings&metal=gold' },
          { label: 'Bangles', href: '/products?category=bangles&metal=gold' },
          { label: 'Chains', href: '/products?category=chains&metal=gold' },
          { label: 'Pendants', href: '/products?category=pendants&metal=gold' },
          { label: 'Earrings', href: '/products?category=earrings&metal=gold' },
          { label: 'Necklace Set', href: '/products?category=necklace-set&metal=gold' },
          { label: 'Bracelets', href: '/products?category=bracelets&metal=gold' },
          { label: 'Nose Pin', href: '/products?category=nose-pin&metal=gold' },
