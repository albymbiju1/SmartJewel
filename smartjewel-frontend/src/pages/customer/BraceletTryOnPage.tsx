...
export function BraceletTryOnPage() {
        ...
        <div className="min-h-screen bg-gray-50 py-8">
            <div className="max-w-6xl mx-auto px-4">
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
                    {/* Try-On Component - Use correct component based on category */}
                    {category?.toLowerCase().includes('bangle') ? (
                        <BangleTryOn productId={productId} bangleCount={bangleCount} category={category} />
                    ) : (
                        <BraceletTryOn productId={productId} bangleCount={bangleCount} category={category} />
                    )}
                </div>
